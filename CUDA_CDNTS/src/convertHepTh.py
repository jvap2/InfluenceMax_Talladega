...
mapping = pd.read_csv("../../Graph_Data_Storage/ca_Hep_mapping.csv")
seeds = pd.read_csv("../../RIM_res/res_HepTh.csv")
cu_rip_seed_lt = pd.read_csv("../../RIM_res/curip_hepth_LT.csv")
cu_rip_seed_ic = pd.read_csv("../../RIM_res/curip_hepth_IC.csv")
...
new_df.to_csv("../../RIM_res/res_HepTh_new.csv", index=False)

new_lt_df = pd.DataFrame(list(zip(lt_seeds)), columns=["Seed_Set"])
new_lt_df.to_csv("../../RIM_res/curip_hepth_LT_new.csv", index=False)

new_ic_df = pd.DataFrame(list(zip(ic_seeds)), columns=["Seed_Set"])
new_ic_df.to_csv("../../RIM_res/curip_hepth_IC_new.csv", index=False)