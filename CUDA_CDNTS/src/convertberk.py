...
mapping = pd.read_csv("../../Graph_Data_Storage/berk_mapping.csv")
seeds = pd.read_csv("../../RIM_res/res_berk.csv")
cu_rip_seed_lt = pd.read_csv("../../RIM_res/curip_berk_LT.csv")
cu_rip_seed_ic = pd.read_csv("../../RIM_res/curip_berk_IC.csv")
...
new_df.to_csv("../../RIM_res/res_berk_new.csv", index=False)

new_lt_df = pd.DataFrame(list(zip(lt_seeds)), columns=["Seed_Set"])
new_lt_df.to_csv("../../RIM_res/curip_berk_LT_new.csv", index=False)

new_ic_df = pd.DataFrame(list(zip(ic_seeds)), columns=["Seed_Set"])
new_ic_df.to_csv("../../RIM_res/curip_berk_IC_new.csv", index=False)