...
./imm -i /home/jvap2/Desktop/Code/Infl_Max/Graph_Data_Storage/homo_ripples.csv -p --seed-set-size 50 --diffusion-model IC --epsilon .5 --streaming-gpu-workers 16 -o imm_wiki.out
cd ../../../../CUDA_RIM/src
