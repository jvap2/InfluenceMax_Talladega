...
meas_1 = "../../RIM_data/berk/meas.csv"
meas_2 = "../../RIM_data/berk/meas_2.csv"
meas_3 = "../../RIM_data/berk/meas_3.csv"
meas_4 = "../../RIM_data/berk/meas_4.csv"
meas_5 = "../../RIM_data/berk/meas_5.csv"
meas_6 = "../../RIM_data/berk/meas_6.csv"
meas_7 = "../../RIM_data/berk/meas_7.csv"
meas_8 = "../../RIM_data/berk/meas_8.csv"
...
seed_set = pd.read_csv("../../RIM_res/res_berk_new.csv")
...
curip_lt_seeds = pd.read_csv("../../RIM_res/curip_berk_LT_new.csv")
curip_lt_seeds = curip_lt_seeds.loc[:,"Seed_Set"].to_numpy()

curip_ic_seeds = pd.read_csv("../../RIM_res/curip_berk_IC_new.csv")
