...
ax3 = plt.subplot2grid((2, 18), (0,10), colspan=3)
ax4 = plt.subplot2grid((2, 18), (0,15), colspan=3)
ax5 = plt.subplot2grid((2, 18), (1,0), colspan=4)
ax6 = plt.subplot2grid((2, 18), (1,7), colspan=4)
ax7 = plt.subplot2grid((2, 18), (1,14), colspan=4)
...
ax1.set_title("Spread vs K")
ax1.plot(hep_K, hep_df_ic_cu, label="HepTh IC_CU")
ax1.plot(hep_K, hep_df_ic, label="HepTh IC_RIMR")
ax1.legend()

ax2.set_xlabel("K")
ax2.set_ylabel("Spread")
ax2.set_title("Spread vs K")
ax2.plot(arxiv_K, arxiv_df_ic_cu, label="Arxiv IC_CU")
ax2.plot(arxiv_K, arxiv_df_ic, label="Arxiv IC_RIMR")
ax2.legend()

ax3.set_xlabel("K")
ax3.set_ylabel("Spread")
ax3.set_title("Spread vs K")
ax3.plot(syn_K, syn_df_ic_cu, label="ND IC_CU")
ax3.plot(syn_K, syn_df_ic, label="ND IC_RIMR")
ax3.legend()

ax4.set_xlabel("K")
ax4.set_ylabel("Spread")
ax4.set_title("Spread vs K")
ax4.plot(amazon_K, amazon_df_ic_cu, label="Amazon IC_CU")
ax4.plot(amazon_K, amazon_df_ic, label="Amazon IC_RIMR")
ax4.legend()

ax5.set_xlabel("K")
ax5.set_ylabel("Spread")
ax5.set_title("Spread vs K")
ax5.plot(berk_K, berk_df_ic_cu, label="Berk IC_CU")
ax5.plot(berk_K, berk_df_ic, label="Berk IC_RIMR")
ax5.legend()

ax6.set_xlabel("K")
ax6.set_ylabel("Spread")
ax6.set_title("Spread vs K")
ax6.plot(epinions_K, epinions_df_ic_cu, label="Epinions IC_CU")
ax6.plot(epinions_K, epinions_df_ic, label="Epinions IC_RIMR")
ax6.legend()

ax7.set_xlabel("K")
ax7.set_ylabel("Spread")
ax7.set_title("Spread vs K")
ax7.plot(wiki_talk_K, wiki_talk_df_ic_cu, label="WikiTalk IC_CU")
ax7.plot(wiki_talk_K, wiki_talk_df_ic, label="WikiTalk IC_RIMR")
ax7.legend()
...
ax1.set_ylabel("Spread")
ax1.set_title("Spread vs K")
ax1.plot(hep_K, hep_df_lt_cu, label="HepTh LT_CU")
ax1.plot(hep_K, hep_df_lt, label="HepTh LT_RIMR")
ax1.legend()
...
ax2.set_ylabel("Spread")
ax2.set_title("Spread vs K")
ax2.plot(arxiv_K, arxiv_df_lt_cu, label="Arxiv LT_CU")
ax2.plot(arxiv_K, arxiv_df_lt, label="Arxiv LT_RIMR")
ax2.legend()
...
ax3.set_ylabel("Spread")
ax3.set_title("Spread vs K")
ax3.plot(syn_K, syn_df_lt_cu, label="ND LT_CU")
ax3.plot(syn_K, syn_df_lt, label="ND LT_RIMR")
ax3.legend()

ax4.set_xlabel("K")
ax4.set_ylabel("Spread")
ax4.set_title("Spread vs K")
ax4.plot(amazon_K, amazon_df_lt_cu, label="Amazon LT_CU")
ax4.plot(amazon_K, amazon_df_lt, label="Amazon LT_RIMR")
ax4.legend()
...
ax5.set_ylabel("Spread")
ax5.set_title("Spread vs K")
ax5.plot(berk_K, berk_df_lt_cu, label="Berk LT_CU")
ax5.plot(berk_K, berk_df_lt, label="Berk LT_RIMR")
ax5.legend()
...
ax6.set_ylabel("Spread")
ax6.set_title("Spread vs K")
ax6.plot(epinions_K, epinions_df_lt_cu, label="Epinions LT_CU")
ax6.plot(epinions_K, epinions_df_lt, label="Epinions LT_RIMR")
ax6.legend()

ax7.set_xlabel("K")
ax7.set_ylabel("Spread")
ax7.set_title("Spread vs K")
ax7.plot(wiki_talk_K, wiki_talk_df_lt_cu, label="WikiTalk LT_CU")
ax7.plot(wiki_talk_K, wiki_talk_df_lt, label="WikiTalk LT_RIMR")
ax7.legend()
...
ax1.set_title("Speedup vs K")
ax1.plot(hep_K, hep_lt_speedup, label="HepTh LT_CU")
ax1.plot(hep_K, hep_ic_speedup, label="HepTh IC_CU")
ax1.legend()

ax2.set_xlabel("K")
ax2.set_ylabel("Speedup")
ax2.set_title("Speedup vs K")
ax2.plot(arxiv_K, arxiv_lt_speedup, label="Arxiv LT_CU")
ax2.plot(arxiv_K, arxiv_ic_speedup, label="Arxiv IC_CU")
ax2.legend()

ax3.set_xlabel("K")
ax3.set_ylabel("Speedup")
ax3.set_title("Speedup vs K")
ax3.plot(syn_K, syn_lt_speedup, label="ND LT_CU")
ax3.plot(syn_K, syn_ic_speedup, label="ND IC_CU")
ax3.legend()

ax4.set_xlabel("K")
ax4.set_ylabel("Speedup")
ax4.set_title("Speedup vs K")
ax4.plot(amazon_K, amazon_lt_speedup, label="Amazon LT_CU")
ax4.plot(amazon_K, amazon_ic_speedup, label="Amazon IC_CU")
ax4.legend()

ax5.set_xlabel("K")
ax5.set_ylabel("Speedup")
ax5.set_title("Speedup vs K")
ax5.plot(berk_K, berk_lt_speedup, label="Berk LT_CU")
ax5.plot(berk_K, berk_ic_speedup, label="Berk IC_CU")
ax5.legend()

ax6.set_xlabel("K")
ax6.set_ylabel("Speedup")
ax6.set_title("Speedup vs K")
ax6.plot(epinions_K, epinions_lt_speedup, label="Epinions LT_CU")
ax6.plot(epinions_K, epinions_ic_speedup, label="Epinions IC_CU")
ax6.legend()

ax7.set_xlabel("K")
ax7.set_ylabel("Speedup")
ax7.set_title("Speedup vs K")
ax7.plot(wiki_talk_K, wiki_talk_lt_speedup, label="WikiTalk LT_CU")
ax7.plot(wiki_talk_K, wiki_talk_ic_speedup, label="WikiTalk IC_CU")
ax7.legend()
