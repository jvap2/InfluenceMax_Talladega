...
ax1 = plt.subplot2grid((2, 15), (0, 0), colspan=3)
ax2 = plt.subplot2grid((2, 15), (0, 4), colspan=3)
ax3 = plt.subplot2grid((2, 15), (0,8), colspan=3)
ax4 = plt.subplot2grid((2, 15), (0,12), colspan=3)
ax5 = plt.subplot2grid((2, 15), (1,1), colspan=3)
ax6 = plt.subplot2grid((2, 15), (1,6), colspan=3)
ax7 = plt.subplot2grid((2, 15), (1,11), colspan=3)
